...
<div class="col-md-4 content-container-left">
    ...
    <form method="post" action="" class="form-melden">
        ...
        <select name="geslacht">
            <option value="volvo">Geslacht</option>
        ...
        <input type="text" name="voorletter" placeholder="Voorletter" />
        ...
        <input type="text" name="afdeling" placeholder="Afdeling" />
...
<?php
		$limit = 40;
		//$limitMax = $limit+19;
		$sql = "SELECT `MedewerkerGeslacht`, `MedewerkerVoorletter`, `MedewerkerAchternaam`, `MedewerkerAfdeling`, `MedewerkerBinnenOfBuitenDienst`  FROM `medewerkers` LIMIT $limit, 24";
