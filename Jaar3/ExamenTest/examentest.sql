...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 24 feb 2018 om 18:20
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `opslag_product`
  ADD CONSTRAINT `opslag_product` FOREIGN KEY (`opslag_id`) REFERENCES `opslag` (`opslag_id`),
  ADD CONSTRAINT `opslag_product_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`);

--
-- Beperkingen voor tabel `product`
--
ALTER TABLE `product`
  ADD CONSTRAINT `fabriekproduct` FOREIGN KEY (`fabriek_id`) REFERENCES `fabriek` (`fabriek_id`);
COMMIT;
